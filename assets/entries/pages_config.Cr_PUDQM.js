...
`,e.jsx(n.span,{"data-line":"",children:" "}),`
`,e.jsxs(n.span,{"data-line":"",children:[e.jsx(n.span,{style:{color:"#D73A49"},children:"export"}),e.jsx(n.span,{style:{color:"#D73A49"},children:" default"}),e.jsx(n.span,{style:{color:"#6A737D"},children:" /* ... */"})]})]})})}),`
`,e.jsxs(n.p,{children:["For more convenience, you can prepend ",e.jsx(n.code,{children:"+"})," to the file names:"]}),`
...
`,e.jsxs(n.p,{children:["You then don't need to define ",e.jsx(n.code,{children:"/pages/product/@id/+config.js"})," anymore: Vike will automatically pick up these ",e.jsx(n.code,{children:"+"})," files."]}),`
...
`,e.jsxs(n.p,{children:["You can use a ",e.jsx(s,{href:"/routing#domain-driven-file-structure",children:"domain-driven file structure"})," for better organization and/or for improved configuration inheritance."]}),`
