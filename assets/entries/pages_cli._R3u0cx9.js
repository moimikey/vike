...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["These are Vike settings, see ",e.jsx(s,{href:"/host",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/port",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/mode",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/prerender",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/force",noBreadcrumb:!0}),". Note that that Vike aliases some Vite settings for convenience, see ",e.jsx(s,{href:"#vite-settings"}),"."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
...
`,e.jsx("h4",{id:"cli-options",children:"CLI options"}),`
`,e.jsxs(n.p,{children:["Vike's CLI supports the following ",e.jsx(n.a,{href:"https://vite.dev/guide/cli#options",children:"Vite CLI options"}),":"]}),`
`,e.jsxs(n.ul,{children:[`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Each of these is a Vike setting that aliases a Vite setting (see ",e.jsx(s,{href:"/host",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/mode",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/port",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/force",noBreadcrumb:!0}),"). Each Vike CLI option sets a ",e.jsx(s,{href:"/settings",children:"Vike setting"}),"."]}),`
