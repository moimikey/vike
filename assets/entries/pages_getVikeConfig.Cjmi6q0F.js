import{o as a,a as t}from"../chunks/chunk-LIyqEPR8.js";import{j as e}from"../chunks/chunk-DQas0v5m.js";import{L as s}from"../chunks/chunk-CNyC8qrJ.js";/* empty css                      */import{W as c}from"../chunks/chunk-CpZQ6f8y.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as i}from"../chunks/chunk-DzGSAgwy.js";/* empty css                      */import{C as d}from"../chunks/chunk-YTIpR75a.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-CPWLhv9T.js";/* empty css                      */const p=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i(),...l.components},{CodeSnippets:o}=n;return o||x("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsx(d,{env:"config (dev & build)",global:null}),`
`,e.jsxs(n.p,{children:["Get the app's ",e.jsx(s,{href:"/config",children:"configurations"})," that are available at config-time."]}),`
`,e.jsx(c,{children:"It's a beta feature: expect breaking changes in any minor version update."}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["It only returns configurations that are available at config-time (i.e. at build- and dev-time). To get configurations at (production) runtime use ",e.jsx(s,{href:"/globalContext#config",children:e.jsx(n.code,{children:"globalContext.config"})})," and ",e.jsx(s,{href:"/globalContext#pages",children:e.jsx(n.code,{children:"globalContext.pages"})})," instead."]}),`
`]}),`
...
`,e.jsx(s,{href:"/config#files"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(s,{href:"/getGlobalContext"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(s,{href:"/globalContext#config",children:["API > ",e.jsx(n.code,{children:"globalContext.config"})]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(s,{href:"/globalContext#pages",children:["API > ",e.jsx(n.code,{children:"globalContext.pages"})]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(s,{href:"/globalContext#prerenderContext",children:["API > ",e.jsx(n.code,{children:"globalContext.prerenderContext"})]}),`
`]}),`
