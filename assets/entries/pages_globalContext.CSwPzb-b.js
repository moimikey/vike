import{j as e,i as r,L as o,o as a}from"../chunks/chunk-HkFgarxq.js";import{L as s}from"../chunks/chunk-Bd9IYMxW.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-U9qlun4q.js";/* empty css                      */import{P as t}from"../chunks/chunk-BJ8aMcFu.js";/* empty css                      *//* empty css                      */const d=[{pageSectionId:"built-in",pageSectionLevel:2,pageSectionTitle:"Built-in"},{pageSectionId:"custom",pageSectionLevel:2,pageSectionTitle:"Custom"},{pageSectionId:"lifecycle",pageSectionLevel:2,pageSectionTitle:"Lifecycle"},{pageSectionId:"server-side",pageSectionLevel:3,pageSectionTitle:"Server-side"},{pageSectionId:"client-side",pageSectionLevel:3,pageSectionTitle:"Client-side"},{pageSectionId:"pre-rendering",pageSectionLevel:3,pageSectionTitle:"Pre-rendering"},{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"},{pageSectionId:"basics",pageSectionLevel:3,pageSectionTitle:"Basics"},{pageSectionId:"narrowing-down",pageSectionLevel:3,pageSectionTitle:"Narrowing down"},{pageSectionId:"extend",pageSectionLevel:3,pageSectionTitle:"Extend"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function l(i){const n={blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"globalContext"})," object is used for storing global information (i.e. information shared by multiple pages)."]}),`
...
`,e.jsxs(n.p,{children:["Eagerly loaded runtime information about all your pages' ",e.jsx(s,{href:"/config",children:"configuration"})," (e.g., all page routes)."]}),`
`,e.jsx(t,{name:"config"}),`
`,e.jsx(n.p,{children:"Environment: server, client"}),`
`,e.jsxs(n.p,{children:["Runtime information about your app's global ",e.jsx(s,{href:"/config",children:"configuration"}),"."]}),`
...
`,e.jsxs(n.p,{children:["When a user starts visiting your website, a new ",e.jsx(n.code,{children:"globalContext"})," object is created that lives until the user closes your website. If the user opens your website in multiple tabs, there is one ",e.jsx(n.code,{children:"globalContext"})," per tab."]}),`
