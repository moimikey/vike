import{j as e,i as l,L as d,o}from"../chunks/chunk-HkFgarxq.js";import{L as s}from"../chunks/chunk-Bd9IYMxW.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-U9qlun4q.js";/* empty css                      */function i({children:r}){return e.jsx("span",{style:{opacity:.85,fontSize:"0.9em",verticalAlign:"middle"},children:e.jsx("code",{children:r})})}const c=[{pageSectionId:"basics",pageSectionLevel:2,pageSectionTitle:"Basics"},{pageSectionId:"html-shell",pageSectionLevel:2,pageSectionTitle:"HTML shell"},{pageSectionId:"advanced",pageSectionLevel:2,pageSectionTitle:"Advanced"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(r){const n={a:"a",blockquote:"blockquote",code:"code",li:"li",p:"p",strong:"strong",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["List of built-in settings. (You can ",e.jsx(s,{href:"/meta",children:"create your own settings"}),".)"]}),`
...
`,e.jsxs(n.p,{children:["Settings that add ",e.jsx(n.code,{children:"<head>"})," tags (aka document metadata):"]}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.p,{children:["You can create your own document metadata settings, see ",e.jsx(s,{href:"/head-tags#custom-settings"}),"."]}),`
`]}),`
`,e.jsx(n.p,{children:"Settings that modify the page's HTML shell:"}),`
`,e.jsxs(n.ul,{children:[`
