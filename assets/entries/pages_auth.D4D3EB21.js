import{o as a,a as t}from"../chunks/chunk-ClvbUOra.js";import{j as e,b as o}from"../chunks/chunk-DveKZrIO.js";import{L as n}from"../chunks/chunk-CDJbc05p.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const i=[{pageSectionId:"pagecontext-user",pageSectionLevel:2,pageSectionTitle:"`pageContext.user`"},{pageSectionId:"ssg",pageSectionLevel:2,pageSectionTitle:"SSG"},{pageSectionId:"login-flow",pageSectionLevel:2,pageSectionTitle:"Login flow"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"In principle, you can use Vike with any authentication tool such as:"}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["If you use ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"vike-server"})}),", you can access the request object at ",e.jsx(s.code,{children:"pageContext.runtime.req.user"})," (see ",e.jsx(n,{href:"/pageContext#runtime",children:e.jsx(s.code,{children:"pageContext.runtime"})}),")."]}),`
