import{j as e,b as a,i as t,L as i,o as r}from"../chunks/chunk-HkFgarxq.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-U9qlun4q.js";/* empty css                      */const o=[{pageSectionId:"vite",pageSectionLevel:2,pageSectionTitle:"Vite"},{pageSectionId:"node-js",pageSectionLevel:2,pageSectionTitle:"Node.js"},{pageSectionId:"typescript",pageSectionLevel:2,pageSectionTitle:"TypeScript"}];function l(n){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:`Instead of using relative import paths,
...
`,e.jsx(a,{path:"/examples/path-aliases"}),`
`]}),`
`]}),`
...
`,e.jsxs(s.li,{children:[`
`,e.jsx(a,{path:"/examples/path-aliases/vite.config.ts"}),`
`]}),`
`]}),`
...
`,e.jsxs(s.li,{children:[`
`,e.jsx(a,{path:"/examples/path-aliases/package.json"}),`
`]}),`
`]}),`
...
for example `,e.jsx(a,{path:"/packages/create-vike-core/boilerplate-react/server/index.js",text:"Express.js server code"}),"."]}),`
...
`,e.jsxs(s.li,{children:[`
`,e.jsx(a,{path:"/examples/path-aliases/tsconfig.json"}),`
`]}),`
