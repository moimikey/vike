...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"+Head"})," setting ",e.jsx(s.strong,{children:"only applies to the HTML"})," of the first page the user visits."]}),`
`,e.jsxs(s.p,{children:["As explained at ",e.jsx(n,{href:"#only-html"}),", you should use ",e.jsx(s.code,{children:"+Head"})," only for ",e.jsx(s.code,{children:"<head>"})," tags that are either:"]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"global"})," (e.g. favicon or PWA settings that don't change between pages), or"]}),`
`,e.jsxs(s.li,{children:["intended for ",e.jsx(s.strong,{children:"crawlers"})," (e.g. SEO or social sharing tags)."]}),`
`]}),`
`,e.jsxs(s.p,{children:["You cannot use ",e.jsx(s.code,{children:"+Head"})," for per-page tags intended for the user's browser such as ",e.jsx(s.code,{children:"<title>"})," (use ",e.jsx(n,{href:"/title",children:e.jsx(s.code,{children:"+title"})})," instead)."]}),`
`]}),`
