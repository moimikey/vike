...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/headers#response",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"headersResponse"})})}),": Add HTTP headers to the HTTP response."]}),`
