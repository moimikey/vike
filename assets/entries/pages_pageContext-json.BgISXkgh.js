...
`,e.jsxs(s.p,{children:["For example, ",e.jsxs(s.a,{href:"https://github.com/vikejs/vike-vue/blob/c2146ea3fd187a58cad26f7025c3c2339bc4229b/packages/vike-vue-pinia/integration/onCreatePageContext.server.ts",children:[e.jsx(s.code,{children:"vike-vue-pinia@0.2.3"})," defines ",e.jsx(s.code,{children:"+onCreatePageContext.server.js"})]}),`
and `,e.jsxs(s.a,{href:"https://github.com/vikejs/vike-react/blob/20942f6e2a392c56767657d5dd66060a0a8a34ae/packages/vike-react-redux/onCreatePageContext.server.ts",children:[e.jsx(s.code,{children:"vike-react-redux@0.1.1"})," as well"]}),`
— since both extensions are tiny, you can consider `,e.jsx(n,{href:"/eject",children:"ejecting"})," them."]}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
