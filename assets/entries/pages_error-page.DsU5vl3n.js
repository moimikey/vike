import{o,a}from"../chunks/chunk-CEb7VmiT.js";import{j as e}from"../chunks/chunk-DzTnyFf2.js";import{L as s}from"../chunks/chunk-DSiGE9UO.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{C as t}from"../chunks/chunk-DCBhm4us.js";/* empty css                      */import"../chunks/chunk-XN8y6aPF.js";/* empty css                      */const i=[{pageSectionId:"pre-rendering",pageSectionLevel:2,pageSectionTitle:"Pre-rendering"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{env:e.jsxs(e.Fragment,{children:["client, and server if ",e.jsx(s,{href:"/ssr",children:e.jsx(n.code,{children:"ssr: true"})})]}),global:!0}),`
`,e.jsxs(n.p,{children:["The error page, which is defined by ",e.jsx(n.code,{children:"/pages/_error/+Page.js"}),`, is rendered when an error occurs. It's also rendered when
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:"Currently, you can define only one error page. See also:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://github.com/vikejs/vike/issues/1038",children:"Feature Request #1038 — Allow multiple error pages"})}),`
`]}),`
`]}),`
