import{o,a}from"../chunks/chunk-ClvbUOra.js";import{j as e,b as t}from"../chunks/chunk-DveKZrIO.js";import{L as n}from"../chunks/chunk-CDJbc05p.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{M as l}from"../chunks/chunk-B30jvmwK.js";/* empty css                      */const d=[{pageSectionId:"what-is-pre-rendering",pageSectionLevel:2,pageSectionTitle:"What is pre-rendering?"},{pageSectionId:"should-i-pre-render",pageSectionLevel:2,pageSectionTitle:"Should I pre-render?"},{pageSectionId:"how-to-pre-render",pageSectionLevel:2,pageSectionTitle:"How to pre-render"},{pageSectionId:"ssg-vs-ssr",pageSectionLevel:2,pageSectionTitle:"SSG vs SSR"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(s){const r={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx("h2",{id:"what-is-pre-rendering",children:"What is pre-rendering?"}),`
...
`,e.jsx(r.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(r.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(r.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(r.span,{"data-line":"",children:e.jsx(r.span,{style:{color:"#6A737D"},children:"// pages/+config.ts"})}),`
`,e.jsx(r.span,{"data-line":"",children:" "}),`
`,e.jsxs(r.span,{"data-line":"",children:[e.jsx(r.span,{style:{color:"#D73A49"},children:"import"}),e.jsx(r.span,{style:{color:"#D73A49"},children:" type"}),e.jsx(r.span,{style:{color:"#24292E"},children:" { Config } "}),e.jsx(r.span,{style:{color:"#D73A49"},children:"from"}),e.jsx(r.span,{style:{color:"#032F62"},children:" 'vike/types'"})]}),`
`,e.jsx(r.span,{"data-line":"",children:" "}),`
...
`,e.jsxs(r.span,{"data-line":"",children:[e.jsx(r.span,{style:{color:"#24292E"},children:"} "}),e.jsx(r.span,{style:{color:"#D73A49"},children:"satisfies"}),e.jsx(r.span,{style:{color:"#6F42C1"},children:" Config"})]})]})})}),`
